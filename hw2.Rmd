...
rsq_te <- cor(ordata_test$target,predicted_te)^2
rsq_te

mae_te <- mean(abs(ordata_test$target - predicted_te))
mae_te

rmse_te <- sqrt(mean((ordata_test$target - predicted_te)^2))
rmse_te
...
rsq_te <- cor(ordata_test$target,predict_te_ridge)^2
rsq_te

mae_te <- mean(abs(ordata_test$target - predict_te_ridge))
mae_te

rmse_te <- sqrt(mean((ordata_test$target - predict_te_ridge)^2))
rmse_te
...
rsq_te <- cor(ordata_test$target,predict_te_lasso)^2
rsq_te

mae_te <- mean(abs(ordata_test$target - predict_te_lasso))
mae_te

rmse_te <- sqrt(mean((ordata_test$target - predict_te_lasso)^2))
rmse_te
...
```{r 2.7}
#sample of process; will need to replace lasso with the model we choose
